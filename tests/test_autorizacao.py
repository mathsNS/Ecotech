...
def test_empresa_atribuida_pode_operar_coleta_domiciliar():
    ...
    repositorio = RepositorioPontosFake({})
    assert empresa_pode_operar_solicitacao("empresa-vencedora", solicitacao, repositorio)
    assert not empresa_pode_operar_solicitacao("empresa-perdedora", solicitacao, repositorio)
