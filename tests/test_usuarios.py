...
def test_criar_cidadao_valido():
    usuario = Cidadao(id="1", nome="Maria", email="maria@email.com", cpf="12345678909")
...
def test_nome_invalido():
    with pytest.raises(ValueError):
        Cidadao(id="1", nome="Ma", email="email@email.com", cpf="12345678909")


def test_email_invalido():
    with pytest.raises(ValueError):
        Cidadao(id="1", nome="Maria", email="email_invalido", cpf="12345678909")
...
def test_registrar_descarte_valido():
    empresa = Empresa(
        id="1", nome="Tech", email="tech@email.com", cnpj="11222333000181", razao_social="Tech LTDA"
    )
...
def test_admin_nivel():
    admin = Administrador(id="1", nome="Admin", email="admin@email.com", nivel=3)

    assert admin.nivel == 3


def test_admin_gerenciar_usuarios():
    admin = Administrador(id="1", nome="Admin", email="admin@email.com", nivel=2)
...
def test_desativar_usuario():
    usuario = Cidadao(id="1", nome="Maria", email="email@email.com", cpf="12345678909")
